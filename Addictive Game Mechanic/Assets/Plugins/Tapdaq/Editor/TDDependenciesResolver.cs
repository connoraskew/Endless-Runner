...
public class TDDependencies : AssetPostprocessor {
	...
	public static void RegisterAndroidDependencies() {
		...
		Google.VersionHandler.InvokeInstanceMethod(
			svcSupport, "DependOn",
			new object[] { "com.google.android.gms", "play-services-ads-identifier", "15.0.0+" },
		...
		if (AssetDatabase.FindAssets ("TapdaqAdMobAdapter").Length > 0) {
			Google.VersionHandler.InvokeInstanceMethod (
				svcSupport, "DependOn",
				new object[] { "com.google.android.gms", "play-services-ads", "15.0.0+" },
				namedArgs: new Dictionary<string, object> () {
					{ "packageIds", new string[] { "extra-google-m2repository" } }
				});
			...
			Google.VersionHandler.InvokeInstanceMethod (
				svcSupport, "DependOn",
				new object[] { "com.google.android.gms", "play-services-ads-lite", "15.0.0+" },
				namedArgs: new Dictionary<string, object> () {
					{ "packageIds", new string[] { "extra-google-m2repository" } }
				});
			...
			Google.VersionHandler.InvokeInstanceMethod (
				svcSupport, "DependOn",
				new object[] { "com.google.android.gms", "play-services-base", "15.0.0+" },
				namedArgs: new Dictionary<string, object> () {
					{ "packageIds", new string[] { "extra-google-m2repository" } }
				});
		}
		...
		//Required by InMobi
		if(AssetDatabase.FindAssets("TapdaqInMobiAdapter").Length > 0 || AssetDatabase.FindAssets("TapdaqFANAdapter").Length > 0) {
			Google.VersionHandler.InvokeInstanceMethod(
				svcSupport, "DependOn",
